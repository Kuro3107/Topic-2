    ...
    <header className="header">
      ...
      <nav className="nav">
        <ul>
          ...
          <li>
            <Link to="/san-pham" className="header-link">Đặt chuyến</Link>
          </li>
          <li>
            <Link to="/gioi-thieu" className="header-link">Giới thiệu</Link>
          </li>

          {isLoggedIn && (
            <li>
              <Link to="/profile" className="header-link">Thông tin cá nhân</Link>
            </li>
          )}
          {isLoggedIn ? (
            <li>
